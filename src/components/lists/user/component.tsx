...
import { ErrorModal } from "../../modals/common/ErrorModal";
...
export const UserList: React.FC<UserListProps> = ({
  ...
  const handleConfirmToggle = useCallback(async () => {
    ...
    try {
      await onToggleActive(pendingData.id, pendingData.isActive);
  ...
  }, [handleError, onToggleActive, pendingData]);
  ...
  return (
    <div className="user-list-container">
        ...
        <div className="pagination-container">
          <div className="pagination-info">
            <p className="pagination-text">
              ...
              de <span className="pagination-highlight">{users.length}</span>{" "}
              usuarios
            </p>
      ...
      <ConfirmationModal
        ...
        title="¿Confirmar cambio estado de usuario?"
        message={`¿Estás seguro de que deseas ${pendingData?.isActive ? "activar" : "poner inactivo"} el usuario seleccionado?`}
